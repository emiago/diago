...
func (d *DialogWebrtc) OnReadRTCP(f func(pkt rtcp.Packet, rtpStats mediawebrtc.RTPReadStats)) {
	d.mu.Lock()
	defer d.mu.Unlock()
	if d.mediaSession != nil {
...
func (d *DialogWebrtc) OnWriteRTCP(f func(pkt rtcp.Packet, rtpStats mediawebrtc.RTPWriteStats)) {
	d.mu.Lock()
	defer d.mu.Unlock()
	if d.mediaSession != nil {
